...
const NG_PLUS_DISTRICTS = [
  ...
  { id: 'hialeah_gardens', name: 'Hialeah Gardens', emoji: '🌺', parent: 'hialeah', incomeLevel: 'low_mid', policeIntensity: 'low', dangerLevel: 3, priceModifier: 0.80, drugSpecialty: 'methamphetamine', gangPresence: [] },
  { id: 'miami_lakes', name: 'Miami Lakes', emoji: '🌴', parent: 'hialeah', incomeLevel: 'mid', policeIntensity: 'low', dangerLevel: 2, priceModifier: 1.0, drugSpecialty: 'xanax', gangPresence: [] },
  ...
  { id: 'homestead', name: 'Homestead', emoji: '🌾', parent: 'kendall', incomeLevel: 'low', policeIntensity: 'low', dangerLevel: 4, priceModifier: 0.75, drugSpecialty: 'methamphetamine', gangPresence: ['dixie_mafia'] },
  { id: 'pinecrest', name: 'Pinecrest', emoji: '🌲', parent: 'kendall', incomeLevel: 'high', policeIntensity: 'low', dangerLevel: 1, priceModifier: 1.2, drugSpecialty: 'adderall', gangPresence: [] },
...
function generateDistrictEvent(state) {
  ...
  const DISTRICT_EVENTS = {
    ...
    suburban_party: { msg: '🏠 Suburban house party. Prescription drug demand up.', heat: 0, cash: 0, demandBoost: ['xanax', 'adderall'] },
