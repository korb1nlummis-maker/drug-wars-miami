      ...
      <div class="sidebar-section">
        ...
        <div class="sidebar-group">
          ...
          <div class="sidebar-group-content ${openSidebarGroups.money ? 'open' : ''}">
            ${_isUnlocked('fronts') ? `<button class="btn btn-sidebar btn-secondary" onclick="currentScreen='fronts'; render();">🏢 Fronts${gameState.frontBusinesses && gameState.frontBusinesses.length > 0 ? ' (' + gameState.frontBusinesses.length + ')' : ''}</button>` : _lockedBtn('🏢', 'Fronts', 'fronts')}
